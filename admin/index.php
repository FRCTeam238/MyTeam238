...
<table class="table text-center">
    ...
    <tr>
        <td>
            <?php if($_SESSION['_admin']['can_view_roster'] == 1){echo('<a href="viewroster"><img src="../images/icons/viewroster.png" border="0" /></a>');}else{echo('<img src="../images/icons-inactive/viewroster.png" border="0" title="Restricted" />');} ?>
        </td>
        <td>
    ...
    <tr>
        <td style="border-top:0px;">View Roster</td>
