...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 * document creator
	 */
	define ('PDF_CREATOR', SITE_FULLNAME.' Content Generator');

	/**
	 * document author
	 */
	define ('PDF_AUTHOR', SITE_FULLNAME.' Content Generator');

	/**
	 * header title
	 */
	define ('PDF_HEADER_TITLE', SITE_SHORTNAME);

	/**
	 * header description string
	 */
	define ('PDF_HEADER_STRING', SITE_FULLNAME . ' :: '. SITE_URL);
